...
const ColorCard = ({ colorName, colorHex, onSelect }: ColorCardProps) => {
  return (
    <button onClick={() => onSelect(colorHex)} className="bg-white border-2 border-gray-400 rounded-lg p-3 transition hover:shadow-lg hover:-translate-y-1 cursor-pointer focus:border-blue-500 focus:shadow-md">
      <div
